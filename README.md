...
This is an exercise to practice using CRUD operations in Graphql. The query and mutation operations are listed below. Run npm install to add the dependencies.
